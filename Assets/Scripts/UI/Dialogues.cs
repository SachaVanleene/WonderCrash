    ...
    private static Dictionary<string, Conv> _conv = new Dictionary<string, Conv> {
        ...
        {"0.3.2", new Conv { interactionListe = new List<Interaction>() {
            new Interaction { id = 1, interaction = "Bonjour collègue. Comment allez-vous aujourd’hui ?", reponseListe = new List<Rep>() {
                new Rep { reponse = "Pas terrible à vrai dire… Un patient vient tout juste de me faire un croche-patte alors que je me baladais dans le couloir...", interacSuiv = 2, soupcon = 5 },
                ...
                new Rep { reponse = "Ça va plutôt bien, mais j'ai oublié comment rejoindre l'étage du dessus", interacSuiv = 4, soupcon = 10 }
                }
            },
