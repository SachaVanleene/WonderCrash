...
public class AfficheTuto : MonoBehaviour {
    ...
    void Start () {
        ...
        if(currentScene.buildIndex == 1) {
            ...
            tutoText.text = "Vous avez atteint l’étage suivant de l’asile mais les gardes sont désormais à votre poursuite ! Essayer de trouver l’escalier de l’étage suivant pour continuer votre évasion. \n\nLes personnes que vous croiserez essayeront de vous empêcher de continuer mais vous pouvez dialoguer avec eux pour les duper. Attention, ils ne réagissent pas de la même façon en fonction de votre personnalité (une chance avec chaque) : il faut changer de personnalité stratégiquement selon vos besoins. \n\nVos réponses provoquent plus ou moins de soupcons chez votre entourage et rester trop longtemps dans une personnalité vous fera sombrer dans la folie… \n\n Bonne courage !";
        }
